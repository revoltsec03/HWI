...
$smtp.Credentials = New-Object System.Net.NetworkCredential("revoltsec03@outlook.com", "Oi01#lo");
$smtp.EnableSsl = $true
$Message.From = "revoltsec03@outlook.com"
$Message.To.Add("revoltsec03@gmil.com")
